...
export class Header extends Component {
    ...
    getActiveElement(element, box) {
        element === this.state.activeElement ? (
            ...
            this.setState({ activeElement: element, box: box }, () => {
            ...
            <header>
                <div className='nav-box'>
                    ...
                    <div className='nav-right-part'>
                        ...
                        <Cart currency={this.props.currency} id={"cart"} activeElement={this.state.activeElement} getActiveElement={this.getActiveElement} orders={this.props.orders} />
                    </div>
                </div>
                {this.state.activeElement === "cart" &&
                    <div className='backgound-overlay'></div>
                }
            </header>
        )
    }
